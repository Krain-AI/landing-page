...
import { TelegramLogo } from "@/components/icons/logo-telegram";
...
const features = [
  ...
  "COLLABORATE WITH LIKEMINDED AI APP USERS AND CREATORS",
...
export function CommunitySection() {
  return (
    <section
      id="community"
      className="relative flex flex-col w-full h-min-screen"
    >
      {/* Background Image */}
      <div
      ...
      {/* Gradient Overlay */}
      {/* <div className="absolute inset-0 h-[60%] md:h-[90%] bg-gradient-to-b from-transparent via-100% to-[#04030C]" /> */}

      {/* Content */}
      <div className="relative flex flex-col items-center justify-between py-24">
